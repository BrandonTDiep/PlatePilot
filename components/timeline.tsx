...
const recipeSteps = [
  ...
  },
  {
    ...
    description: "Type in your ingredients and receive recipes containing those.",
    ...
    <section ref={containerRef} className="relative py-20 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">Recipes generated for your ingredients.</p>
        </motion.div>
